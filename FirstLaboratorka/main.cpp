...
int main()
{
    ...
    a = 5;
    b = 6;
    cout << a + b << endl; //пример ариф операции с целочисленным типом данных

    float x, y;
    x = 11,5;
    y = 5,7;
    cout << x + y << endl; //пример ариф операции с вещественным типом данных
    
    unsigned int u_a, u_b;
    u_a = 555;
    u_b = 445;
    int c = u_a + u_b;  // пример ариф операции с беззнаковым типом данных
    cout << c << endl;
